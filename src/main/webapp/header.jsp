  ...
  <nav class="container-xxl navbar px-3 column-gap-4">
    ...
    <form class="flex-fill">
      <div class="input-group">
        ...
        <button class="input-group-text p-0 px-2 ci ci-close text-blue" id="search-clear" type="button" onclick="search_delete(this)" hidden></button>
        ...
        <tr>
          <td valign="bottom">
            <a class="d-flex flex-column align-items-center">
              ...
              <p style="font-size: small;">Iniciar sesión</p>
            </a>
          </td>
          <td valign="bottom">
