            ...
            <div class="row p-0 m-0">
                <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="datelles_cuenta.jsp"><i class="fas fa-user"></i> Detalles de Cuenta</a></li>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                    ...
                    <div class="section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" value="jorgerivas9725@gmail.com" readonly>
